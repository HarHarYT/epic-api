...
token_url = "https://account-public-service-prod.ol.epicgames.com/account/api/oauth/token"
                                                    ...
                                                    if token_response.status_code == 200:
                                                        ...
                                                        # Second request for device authorization
                                                    ...
                                                    accid = device_auth_data['accountId']
                                                            ...
                                                            print("Failed to get device code:", device_auth_response.status_code, device_auth_response.text)

                                                    else:
                                                        print("Failed to get access token:", token_response.status_code, token_response.text)
